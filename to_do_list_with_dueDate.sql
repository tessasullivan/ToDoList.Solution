...
--
-- Host: localhost:8889
-- Generation Time: May 14, 2019 at 10:22 PM
...
--
CREATE DATABASE IF NOT EXISTS `to_do_list_with_dueDate` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
